  ...
  return (
    <footer className="footer sm:footer-horizontal bg-neutral text-neutral-content p-10">
      ...
      <nav>
        ...
        <Link to="/" className="link link-hover">À propos</Link>
        <a href="mailto:contact@reussirsoncv.com" className="link link-hover">Contact</a>
        <a href="tel:+33612345678" className="link link-hover">Assistance</a>
      </nav>
      <nav>
        <h6 className="footer-title">Légal</h6>
        <Link to="/mentions-legales" className="link link-hover">Mentions légales</Link>
        <Link to="/politique-confidentialite" className="link link-hover">Politique de confidentialité</Link>
