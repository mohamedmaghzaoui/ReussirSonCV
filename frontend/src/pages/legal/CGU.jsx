export const CGU = () => {
  return (
    <div className="p-6 max-w-5xl mx-auto text-gray-800">
      ...
      <p>Les présentes conditions ont pour objet de définir les modalités d’accès et d’utilisation du site ReussirSonCV.</p>

      <h2 className="text-xl font-semibold mt-6 mb-2">2. Accès au site</h2>
      <p>L’accès au site est gratuit. Pour bénéficier des fonctionnalités avancées, l’utilisateur doit créer un compte.</p>

      <h2 className="text-xl font-semibold mt-6 mb-2">3. Obligations des utilisateurs</h2>
      ...
      <p>ReussirSonCV ne peut être tenu responsable des dommages directs ou indirects liés à l'utilisation du site.</p>

      <h2 className="text-xl font-semibold mt-6 mb-2">5. Modification des CGU</h2>
      <p>Nous nous réservons le droit de modifier les présentes CGU à tout moment. Les utilisateurs seront informés via le site.</p>
