export const PolitiqueConfidentialite = () => {
  return (
    <div className="p-6 max-w-5xl mx-auto text-gray-800">
      ...
      <p className="mb-4">
        Cette politique de confidentialité définit la manière dont ReussirSonCV
        utilise et protège les informations que vous transmettez en utilisant ce
        site.
      </p>
      ...
      <p>
        Les données sont conservées aussi longtemps que nécessaire pour les
        finalités décrites ou jusqu’à la suppression de votre compte.
      </p>
