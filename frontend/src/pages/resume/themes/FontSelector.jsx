...
export const FontSelector = ({ resume, setResume }) => {
  ...
  return (
    <div className="dropdown ml-10 dropdown-bottom lg:dropdown-end w-full lg:w-auto">
      ...
      <div
        tabIndex={0}
        className="dropdown-content z-[1] bg-base-100 p-4 mt-2 shadow rounded-box w-75"
      >
        ...
        <div className="grid grid-cols-2 gap-4 w-65">
          {fonts.map((font, index) => (
            <div
              ...
              className={`cursor-pointer border transition-all px-1 duration-150 hover:scale-110 ${
