...
const ResumePopUp = React.lazy(() => import("../../components/ResumePopUp.jsx"));
    ...
    <div>
      ...
      <section className="px-6 py-10 mb-10">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          ...
          <div
            onClick={openPopUp}
            className="card cursor-pointer  bg-[#D3D3D3] shadow-md p-6 rounded-box text-center h-80 w-70 flex flex-col justify-center items-center"
          >
      ...
      {isPopUpOpen && (
        <Suspense
          fallback={<div className="text-center p-4">Chargement...</div>}
        >
